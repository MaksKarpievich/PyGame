...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.um = QPushButton('*', self)
        self.um.resize(50, 50)
        self.um.move(170, 155)
        ...
        self.ostatok.move(5,375)

        self.delnachelo=QPushButton('//',self)
        self.delnachelo.resize(50,50)
        self.delnachelo.move(60,375)
    ...
    def ravn_1(self):
        ...
        if self.operation=='/':
            if self.operand_2==0:
                ...
                self.result=self.operand_1/self.operand_2
        if self.operation==')':
            self.result=self.operand_1**(1/self.operand_2)
